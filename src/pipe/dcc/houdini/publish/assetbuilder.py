...
# Mirrors `HoudiniBuildError.error_code` in `pipe.dcc.maya.publish.asset`. Houdini's
# parent package (`pipe.dcc.houdini`) eagerly imports `hou`, so Maya cannot import the
