...
from pipe.framework.dispatch import find_implementation
from pipe.framework.interface import DCCLauncher
...
def launch(
    ...
    launcher_cls = find_implementation(DCCLauncher, f"pipe.dcc.{software_name}")
