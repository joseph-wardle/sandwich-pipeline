...
to a `pipe.core.shotgrid.client.ShotGrid` connection lazily fetches the full
...
class SGEntity:
    ...
    to a `pipe.core.shotgrid.client.ShotGrid` connection, the entity calls
