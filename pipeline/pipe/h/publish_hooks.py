...
Design goals:
1. Keep hook behavior decoupled from `pipe.h.publish`.
...
_LEGACY_SPEC_ALIASES = {
    "pipe.h.publish_hooks.turnaround:run": "turnaround",
    "pipe.h.publish_hooks.turnaround_shotgrid:run": "turnaround_shotgrid",
}
