...
# They now live in pipe.sp.metadata but are re-exported here so that
# existing import paths continue to work.
from pipe.sp.metadata import (  # noqa: E402, F401
